...
import customerHostedMatchesRoutes from "../modules/hostedMatches/customer.hostedMatches.routes";
import { customerNotificationsRouter } from "../modules/notifications/customer.notifications.routes";
...
router.use("/hosted-matches", customerHostedMatchesRoutes);
router.use("/notifications", customerNotificationsRouter);
